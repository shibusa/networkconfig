...
vlanid = MenuItem("Create VLAN", {'juniper':JNPreturn.vlanid.run, 'cisco':CSCreturn.vlanid.run})
menu.append(vlanid)
vlantoint = MenuItem("Assign VLAN to interface", {'juniper':JNPreturn.vlantoint.run, 'cisco':CSCreturn.vlantoint.run})
